function jumpBox() {
  $(".startVideo").on("click", function () {
    ifopen ||
      ...
      "iframe1" == $(this).prev().children().find("div").attr("id")
        ? $(".loading").text($("fieldset #iframe1").html())
        : "tziframe" == $(this).prev().children().find("div").attr("id")
        ? $(".loading").text($("fieldset #tziframe").html())
        : "haveBgIframe" == $(this).prev().children().find("div").attr("id")
        ? $(".loading").text($("fieldset #haveBgIframe").html())
        : "noBgIframe" == $(this).prev().children().find("div:eq(1)").attr("id")
        ? $(".loading").text($("fieldset #noBgIframe").html())
        : "Iframe1" == $(this).parent().prev().attr("id")
        ? $(".loading").text($("fieldset #Iframe1").html())
        : "Iframe2" == $(this).parent().prev().attr("id") &&
          $(".loading").text($("fieldset #Iframe2").html()));
  }),
...
function getK(e) {
  switch (1 * e) {
    ...
    case 10084:
      ...
      break;
    case 1001:
      jumpHtml("view/shishicai_ether/ssc_index.html");
      break;
    case 1002:
      jumpHtml("view/shishicai_tron/ssc_index.html");
  }
}
function getH(e) {
  switch (1 * e) {
    ...
    case 10084:
      ...
      break;
    case 1001:
      jumpHtml("view/shishicai_ether/ssc_kjhistory.html");
      break;
    case 1002:
      jumpHtml("view/shishicai_tron/ssc_kjhistory.html");
  }
}
function jumpHtml(e) {
  var i = config.jump();
  "stagingEnv" === env && (i = config.url), window.open(i + "" + e);
}
function operatorTime(e, i) {
  ...
  return (
    (t = t.replace("-", "/")),
    (i = i.replace("-", "/")),
    (new Date(t).getTime() - new Date(i).getTime()) / 1e3
  );
}
var env = "productionEnv",
  config = {
    ...
    path: function () {
      var e = window.location.href,
        i = "https" == e.split(":")[0] ? "https" : "http";
      return config.ifdebug
        ? i + "://" + e.split("/")[2] + "/168/168_kaiTransfer1/view/"
        : -1 != e.split("/")[2].indexOf("192")
        ? i + "://" + e.split("/")[2] + "/168/168_kaiTransfer1/view/"
        : i + "://" + e.split("/")[2] + "/view/";
    },
    ym: function () {
      ...
      return "" == e || void 0 == e
        ? "?" + config.wwwUrl.split("//")[1]
        : "?" + e;
    },
    ymL: function () {
      var e = window.location.search.split("?");
      return "" == (e = e[e.length - 1]) || void 0 == e
        ? "?" + config.wwwUrl.split("//")[1]
        : "?" + e;
    },
    jump: function () {
    ...
    goToPage: function (e) {
      var i = config.jump(),
        t = [
          "view/about_us/about_us.html",
          "view/about_us/cus_serv.html",
          "view/about_us/coop_com.html",
          "view/about_us/disclaimer.html",
        ];
      window.open(i + t[e]);
    },
    logo: function () {
  ...
  BLOCK_CHAIN_LIST = ["1001", "1002"];
"stagingEnv" == env &&
  ((config.publicUrl =
    "http://staging-api2-168-al2.puz2crbmjw.ap-northeast-1.elasticbeanstalk.com/"),
  (config.publicUrl_blockChain =
    "http://staging-168block-api.puz2crbmjw.ap-northeast-1.elasticbeanstalk.com/"),
  (config.url =
    "http://staging-168kai2.jc2vgpwxmg.ap-northeast-1.elasticbeanstalk.com/"));
...
(config.formatDate = function (e) {
  ...
  $(function () {
    jumpBox(), $("#localyears").text(new Date().getFullYear());
  });
var ifopen = !1;
(config.isBlockChain = function (e) {
  return BLOCK_CHAIN_LIST.includes(e);
}),
  (config.convertBlockChainTypeToLotCode = function (e) {
    switch (e) {
      case "1001":
        return "ether";
      case "1002":
  ...
  (config.getBlockChainData = function (e) {
    switch (e) {
      case "1001":
        return {
          name: "ether",
          blockHeightLink: "https://etherscan.io/block/",
        };
      case "1002":
        return {
          name: "tron",
          blockHeightLink: "https://tronscan.org/#/block/",
        };
    }
  });
